...
, recordsperpage: 10, datacontainer: 'tblFichas', dataelement: 'tr',
    ...
    $('#btnsubirArchivoFichas').click('click', function () {
        var f = $("#FormAsociarEtapa");
        $('#FormAsociarEtapa').attr('action', '/Etapa/SubirArchivoFichas');
        $("#FormAsociarEtapa").submit()
    });


    //    // 21/05/2013 - DI CAMPLI LEANDRO - IMPORTAR EXCEL CON ID FICHAS
//    $('#CargarFichasEtapaXLS').click('click', function () {
//        var f = $("#FormAsociarEtapa");
//        $('#FormAsociarEtapa').attr('action', '/Etapa/CargarFichasEtapaXLS');
//        $("#FormAsociarEtapa").submit()
//        });

        // 21/05/2013 - DI CAMPLI LEANDRO - ASIGNAR FICHAS A ETAPA
        //
